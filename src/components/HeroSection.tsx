      ...
      <motion.div
        ...
        <div className="dotted-bg rounded-3xl bg-card border border-border overflow-hidden px-8 py-12 md:px-12 relative text-center">
          ...
          <motion.p
            ...
            Sr. Product Designer with 5+ years of experience building SaaS and AI products for startups. Currently leading Design{" "}
          ...
          <motion.p
            ...
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            transition={{ delay: 0.6 }}>Industry Contributed: E-commerce, Procurement, Sales, Sports Management, Facility, Fintech, Blockchain
